...
create_lsnrctl() {
    echo_green "START NETCA" 
    netca /silent  /responseFile /assets/netca.rsp
    echo_green "Netca created."
}  

create_agent10g() {
    echo_green "install agent10g" 
    /agent/linux_x64/agent/runInstaller -silent -responseFile /assets/additional_agent.rsp
    echo_green "Agent10g installed."
}
